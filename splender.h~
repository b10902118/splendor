...
bool cmp(const card &x, const card &y) { return x.id < y.id; }

void start(vector<card> &stack_1, vector<card> &stack_2,
           vector<card> &stack_3) {
...
struct move server_move(struct move m) {
    ...
    do {
        ...
        case 1:
            ret.gem[0] =
            input_int("How many emerald tokens you want to purchase? "
